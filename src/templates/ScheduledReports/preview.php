<?php
/**
 * Scheduled Reports Preview (P4-010)
 *
 * Shows a preview of what the email report will look like.
 *
...
<div class="content-header">
    <h1><?= __('Report Preview') ?>: <?= h($report->name) ?></h1>
...
<div class="card" style="padding: 0;">
    <div style="padding: 12px 20px; background-color: #f8f9fa; border-bottom: 1px solid #e0e0e0; font-size: 13px; color: #666;">
        <?= __('Recipients') ?>: <?= h(implode(', ', $report->getRecipientsArray())) ?>
        &middot; <?= __('Frequency') ?>: <?= h($report->getFrequencyLabel()) ?>
    </div>
