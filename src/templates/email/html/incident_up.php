...
<div style="font-family: Arial, Helvetica, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    <div style="background-color: #ffffff; padding: 24px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 4px 4px;">
        <p style="font-size: 16px; color: #333333;">
            <?= __d('emails', 'The monitor {0} is back {1}.', '<strong>' . h($monitor->name ?? $incident->title) . '</strong>', '<strong style="color: #43A047;">' . __d('emails', 'ONLINE') . '</strong>') ?>
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr>
                ...
                <td style="padding: 8px 12px; border-bottom: 1px solid #eee;">
                    <span style="color: #43A047; font-weight: bold;"><?= __d('emails', 'ONLINE') ?></span>
                </td>
            </tr>
        ...
        <p style="font-size: 12px; color: #999;">
            <a href="<?= $unsubscribeUrl ?>" style="color: #999;"><?= __d('emails', 'Unsubscribe') ?></a>
        </p>
        <?php endif; ?>
    </div>
</div>
